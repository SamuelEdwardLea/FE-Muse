...
const Navbar = () => {
  return (
    ...
    <li className="navItem"><NavLink exact to ="/home" style={{marginLeft: "33vw"}}><img src="https://image.flaticon.com/icons/svg/89/89560.svg" style={{height: '10vh', width: 'auto'}}></img></NavLink></li>
    </ul>
  )
}
